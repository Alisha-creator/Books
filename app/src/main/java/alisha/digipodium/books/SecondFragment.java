package alisha.digipodium.books;
...
public class SecondFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if(getArguments() !=null){
            ...
            TextView textGeneres = view.findViewById(R.id.textGenres);
            TextView textDescription = view.findViewById(R.id.textDescription);
            ImageView imageBook = view.findViewById(R.id.imageBook);
            textTitle.setText(args.getTitle());
            textAuthor.setText(args.getAuthor());
            textGeneres.setText(args.getGenres());
